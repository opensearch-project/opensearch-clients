...
1. Add the [backport](https://github.com/opensearch-project/opensearch-java/blob/main/.github/workflows/backport.yml) workflow in your repo.
...
3. Add [auto delete](https://github.com/opensearch-project/opensearch-java/blob/main/.github/workflows/delete_backport_branch.yml) workflow for deleting the backport branches once the backport PRs are merged. This enables the backport workflow to clean up after itself.
...
- Original PR: https://github.com/opensearch-project/opensearch-java/pull/148 with label `backport 1.x`.
- Backport PR: https://github.com/opensearch-project/opensearch-java/pull/151 with merged backport branch auto deleted.
